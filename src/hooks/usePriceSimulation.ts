    ...
    switch (tab) {
      ...
      case 'readymade':
        return allOrders.filter(o => {
          const isCustom = o.category === '別注' || o.category === 'ポリ別注' || o.category.includes('別注');
          const isSP = (o.category.includes('SP') || o.category.includes('ＳＰ')) && !o.category.includes('シルク');
          const isSticker = o.category.includes('シール');
          return !isCustom && !isSP && !isSticker && o.productCode !== '999999999';
        });
      default:
        return allOrders;
    }
